                ...
                <section className=" relative mt-16">
                    ...
                    <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12 ">
                        <a rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto  sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12">
                            <img src="/asset/foto8.jpeg" alt="" className="shadow-lg transition-shadow duration-300 hover:shadow-xl object-cover w-full h-64 rounded sm:h-96 lg:col-span-7 pt-0 mt-5" />
                            <div className="p-6 mt-6 space-y-2 lg:col-span-5">
                                ...
                                <p className='text-white-color2 font-semibold'>Nama lengkap: Nabila Risha Juliana<br />
                                    Panggilan: Risha<br />
                                    Kelas: XI RPL 1<br />
                                    Alamat: Jl.Candi Agung lll no. 11, Malang <br />
                                    Tempat,Tanggal lahir: Bekasi, 19 Juli 2006<br />
                                    No telp: 0818199220<br />
                                    Asal sekolah: SMK TELKOM MALANG<br />
                                    Hobi: Menonton, Makeup<br />
                                    Softskill: Self-Control,Komunikasi yang baik,Kreativitas Tinggi, Ketekunan <br />
                    ...
                    <section className="py-6 sm:py-12 dark:bg-gray-800 dark:text-gray-100">
                        <div className="container p-6 mx-auto space-y-8">
                            ...
                            <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                <article className="flex flex-col bg-white-color2">
                                    <a rel="noopener noreferrer" href="https://profile-triplen.vercel.app/" aria-label="Te nulla oportere reprimique his dolorum">
                                        <img alt="" className="object-cover w-full h-52 dark:bg-gray-500" src="/asset/porto9.png" />
                                    </a>
                                    <div className="flex flex-col flex-1 p-6">
                                        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">React Web Profile Team</h3>
                                        <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
                                            <span>2023</span>
                                            <span><MdFavorite/></span>
                                        </div>
                                ...
                                <article className="flex flex-col bg-white-color2">
                                    <a rel="noopener noreferrer" href="https://news-web-kelompok7-new.vercel.app/" aria-label="Te nulla oportere reprimique his dolorum">
                                        <img alt="" className="object-cover w-full h-52 dark:bg-gray-500" src="/asset/porto8.png" />
                                    </a>
                                    <div className="flex flex-col flex-1 p-6">
                                        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">Web News</h3>
                                        <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
                                            <span>2023</span>
                                            <span><MdFavorite/></span>
                                        </div>
                                ...
                                <article className="flex flex-col bg-white-color2">
                                    <a rel="noopener noreferrer" href="https://profile-triplen.vercel.app/calculator" aria-label="Te nulla oportere reprimique his dolorum">
                                        <img alt="" className="object-cover w-full h-52 dark:bg-gray-500" src="/asset/porto10.png" />
                                    </a>
                                    <div className="flex flex-col flex-1 p-6">
                                        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">React Web Calculator</h3>
                                        <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
                                            <span>2023</span>
                                            <span><MdFavorite/></span>
                                        </div>
                                ...
                                <article className="flex flex-col bg-white-color2">
                                    ...
                                    <div className="flex flex-col flex-1 p-6">
                                        <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">Web Calculator BMI</h3>
                                        <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
                                            <span>2023</span>
                                            <span><MdFavorite/></span>
                                        </div>
